...
{
#if defined(WIN32) || defined(WIN64) || defined(DJGPP)
...
input_stack_entry *input_stack_pop(asmstate_t *as, unsigned long magic, int (*fn)(input_stack_entry *e, void *data), void *data)
{
